...
const API_BASE_URL = "/hdmoviesandshows";
 ...
 * @returns
 */
export const hdMoviesAndShowsLoader = async () => {
  ...
  try {
    ...
    //    console.log(
    //      "hdMoviesAndShowsLoader> response.data: " + JSON.stringify(response.data)
    //    );
    ...
    if (err.response) {
      ...
      console.log(`hdMoviesAndShowsLoader> Error: ${err.message}`);
    }
  }
  return [];
};
