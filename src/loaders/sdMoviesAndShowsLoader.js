...
const API_BASE_URL = "/sdmoviesandshows";
 ...
 * @returns
 */
export const sdMoviesAndShowsLoader = async () => {
  ...
  try {
    ...
    //    console.log(
    //      "sdMoviesAndShowsLoader> response.data: " + JSON.stringify(response.data)
    //    );
    ...
    if (err.response) {
      ...
      console.log(`sdMoviesAndShowsLoader> Error: ${err.message}`);
    }
  }
  return [];
};
